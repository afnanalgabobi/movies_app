...
class CustomTextFormField extends StatelessWidget {
  ...
  CustomTextFormField({super.key,
    ...
    this.fillColor=AppColors.grayColor,
    this.hintText,
    this.hintStyle,
    this.labelText,
    this.labelStyle,
    ...
    return TextFormField(
      decoration: InputDecoration(
        ...
        fillColor: fillColor,
          ...
          errorStyle: AppStylesRoboto.regular14White.copyWith(
              color: AppColors.redColor
          ),
          hintText: hintText,
          hintStyle: hintStyle?? AppStylesRoboto.regular16White,
          labelText: labelText,
          labelStyle: hintStyle?? AppStylesRoboto.regular16White,
